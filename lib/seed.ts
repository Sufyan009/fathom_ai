...
export const USERS: User[] = [
  { id: "u_maya", name: "Mohsin Ali", email: "mohsin@northwind.io", avatarColor: C.indigo, initials: "MA" },
...
const roadmap: Meeting = {
  ...
  attendees: [
    { name: "Mohsin Ali", email: "mohsin@northwind.io", isHost: true, speakerLabel: "Mohsin", talkTimeS: 940, color: C.indigo },
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Sam to define pricing experiment success metrics with Mohsin.",
          ],
        },
      ],
    },
  ...
  transcript: cues([
    ["Mohsin", 0, "Alright, we're all here — thanks everyone. Goal today is to walk out with three Q3 bets and an owner on each. No solo heroics, real owners."],
    ["Mohsin", 40, "Quick reality check first. Activation was basically flat last quarter even after the onboarding refresh, and reliability incidents doubled month over month. Those two numbers frame everything."],
    ...
    ["Mohsin", 180, "Good. Tomás can you confirm the backfill completion date by end of day? I want it as a tracked item."],
    ...
    ["Mohsin", 480, "Okay. I'm hearing guided setup as the headline activation bet. Any objection?"],
    ...
    ["Mohsin", 600, "Perfect, that's bet one, Priya owns it. Let's do reliability next."],
    ...
    ["Mohsin", 900, "Great, that's bet two, Devon owns reliability. Third bet — Sam, the pricing experiment."],
    ...
    ["Mohsin", 1080, "I like it if it's genuinely small. Sam, define success metrics with me this week so we don't move the goalposts later."],
    ...
    ["Mohsin", 1350, "That's a real risk. Let's note it — we may need to stagger the pricing rollout after reliability stabilizes."],
    ...
    ["Mohsin", 1600, "Mobile's important but it's not a Q3 headline — let's fold the quick wins into the checklist work and revisit mobile as its own bet in Q4."],
    ["Hannah", 1670, "Tokens v2 will actually help mobile polish, so some of that comes for free."],
    ["Mohsin", 1740, "Love it. So: bet one guided setup, Priya. Bet two reliability, Devon. Bet three pricing experiment, Sam, staggered. Reporting revamp slips to a Q4 fast-follow."],
    ["Sam", 1810, "Clean. That's the most focused plan we've had in a while."],
    ["Mohsin", 1870, "Let's keep it that way. I'll send notes and the action items right after this. Thanks everyone."],
...
const oneOnOne: Meeting = {
  ...
  attendees: [
    { name: "Mohsin Ali", email: "mohsin@northwind.io", isHost: true, speakerLabel: "Mohsin", talkTimeS: 360, color: C.indigo },
  ...
  actionItems: [
    { id: "a1", text: "Rebalance Devon's load — move one report to Sam's pod", assignee: "Mohsin Ali", done: false, atMs: min(14) },
    { id: "a2", text: "Draft a tech-lead growth plan with concrete milestones", assignee: "Mohsin Ali", done: false, atMs: min(19) },
  ],
  highlights: [
    { id: "h1", startMs: min(13), endMs: min(15), label: "Ask: rebalance load", createdBy: "Mohsin Ali", createdAt: "2026-09-04T15:20:00.000Z", cueIds: ["c5"] },
  ],
  comments: [],
  transcript: cues([
    ["Mohsin", 0, "How are you doing, honestly? Not the status-update version."],
    ...
    ["Mohsin", 180, "That's fair. If we could take one thing off your plate, what would move the needle most?"],
    ...
    ["Mohsin", 330, "Both reasonable. Let me rebalance — I'll move one report and I'll be explicit with the team that reliability comes first for you right now."],
    ["Devon", 410, "That would help a lot. Longer term, I want to be moving toward a tech-lead role."],
    ["Mohsin", 480, "Good — the reliability workstream is a perfect proving ground. Let me draft a growth plan with real milestones so it's not vague."],
...
export const CALENDAR: CalendarEvent[] = [
  {
    ...
    durationS: 30 * 60,
    platform: "zoom",
    attendees: ["Mohsin Ali", "Devon Park", "Priya Nair", "Sam Rivera"],
    willRecord: true,
  },
  {
    id: "cal2",
  ...
  },
  {
    ...
    durationS: 30 * 60,
    platform: "teams",
    attendees: ["Hannah Weiss", "Mohsin Ali"],
    willRecord: false,
  },
];
